...
// The properties of the contructor. ie name, age and hometown.
// 2. What is "this" when joe.scopeArrow() is invoked?
// The global window object 
// 3. Explain why "this" is different when an arrow function is used.
//  The 'this' context is not reset within an arrow function and is the same as the 'this' of the surrounding non-arrow functions (enclosing scope). 